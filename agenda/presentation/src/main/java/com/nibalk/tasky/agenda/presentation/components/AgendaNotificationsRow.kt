...
fun AgendaNotificationsRow(
    ...
    currentType: ReminderDurationType = ReminderDurationType.THIRTY_MINUTES,
    isEditable: Boolean,
    onMenuItemClicked: (ReminderDurationType) -> Unit,
) {
    ...
    Box(
        ...
        TaskyDropDownMenu(
            ...
            menuItems = ReminderDurationType.entries.toList().map { type->
